  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        setError('')
        setLoading(true)
        const data = await apiFetch('/api/products?category=Men', { auth: false, signal: controller.signal })
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <h1 className="mt-1 text-3xl font-extrabold tracking-tight text-gray-900">Men</h1>
            <p className="mt-1 text-sm text-gray-600">Men clothing collection</p>
          </div>
